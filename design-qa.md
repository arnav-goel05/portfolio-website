...
- Patches made since previous QA pass: copied the TRIBE optimizer graph from the linked repo, added TRIBE project route/data entries, reduced oversized case-section heading typography, and removed the temporary case-study slot.
